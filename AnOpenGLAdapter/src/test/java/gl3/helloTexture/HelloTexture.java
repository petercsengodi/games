 ...
 * @author gbarbieri
 */
public class HelloTexture implements GLEventListener, KeyListener, Disposable {
    ...
    private String title = "Hello Texture";
    ...
    private final String SHADERS_ROOT = "res/example";
    private final String TEXTURE_ROOT = "res/example";
...
//        System.out.println("display");
	...
	private static final Logger logger = LoggerFactory.createLogger(HelloTexture.class);
}
