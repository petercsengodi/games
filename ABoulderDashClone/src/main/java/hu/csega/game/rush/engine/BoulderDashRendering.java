...
public class BoulderDashRendering implements GameRendering {

	public BoulderDashRendering(BoulderDashRenderingOptions options) {
	...
	public void render(GameGraphics g) {
		...
		// BoulderDashModel bdModel = (BoulderDashModel) model;
...
//		}
	...
	private BoulderDashRenderingOptions options;
